...
namespace Beautify.Universal {
    ...
    public class Beautify : VolumeComponent, IPostProcessComponent {
        ...
        public ClampedFloatParameter outlineMinDepthThreshold = new ClampedFloatParameter(0.0005f, 0f, 1f);

        [ArtisticChoices, Outline, DisplayName("Saturation Diff Threshold")]
        public ClampedFloatParameter outlineSaturationDiffThreshold = new ClampedFloatParameter(0.015f, 0f, 1f);
