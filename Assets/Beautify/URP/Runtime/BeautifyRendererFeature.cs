            ...
            static void UpdateMaterialProperties() {
                ...
                if (canUseDepthTexture) {
                    if (beautify.outline.value && (beautify.optimizeBuildBeautifyAuto.value || !beautify.stripBeautifyOutline.value)) {
                        ...
                        bMat.SetVector(ShaderParams.outlineData, new Vector4(beautify.outlineIntensityMultiplier.value, outlineDistanceFade, beautify.outlineMinDepthThreshold.value, beautify.outlineSaturationDiffThreshold.value));
